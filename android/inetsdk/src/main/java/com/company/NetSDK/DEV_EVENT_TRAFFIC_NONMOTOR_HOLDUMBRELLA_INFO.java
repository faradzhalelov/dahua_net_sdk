 ...
 * \if ENGLISH_LANG
 *
 * @brief Corresponding to data block description of event type EVENT_IVS_TRAFFIC_NONMOTOR_HOLDUMBRELLA
 * \else
 * @brief 事件类型 EVENT_IVS_TRAFFIC_NONMOTOR_HOLDUMBRELLA (非机动车装载伞具事件) 对应的数据块描述信息
 * \endif
 */
public class DEV_EVENT_TRAFFIC_NONMOTOR_HOLDUMBRELLA_INFO implements Serializable {
    /**
     *
     */
