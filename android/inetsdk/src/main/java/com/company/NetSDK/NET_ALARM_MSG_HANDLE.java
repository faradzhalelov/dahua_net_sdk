...
import com.company.NetSDK.NET_CFG_EVENT_TITLE;
import com.company.NetSDK.NET_CFG_LIGHTING_LINK_INFO;
import com.company.NetSDK.NET_CFG_MAIL_DETAIL;
import com.company.NetSDK.NET_CFG_PSTN_ALARM_SERVER;
import com.company.NetSDK.NET_CFG_PTZ_LINK;
import com.company.NetSDK.NET_CFG_TALKBACK_INFO;
import com.company.NetSDK.NET_CFG_TIME_SCHEDULE;
import com.company.NetSDK.NET_CFG_TOURLINK;
import com.company.NetSDK.NET_EM_CFG_ACCESSCONTROLTYPE;
import com.company.NetSDK.NET_PTZ_LINK;
...
public class NET_ALARM_MSG_HANDLE implements Serializable {
     ...
     * \endif
     */
    public NET_CFG_LIGHTING_LINK_INFO stuLightingLink = new NET_CFG_LIGHTING_LINK_INFO();
