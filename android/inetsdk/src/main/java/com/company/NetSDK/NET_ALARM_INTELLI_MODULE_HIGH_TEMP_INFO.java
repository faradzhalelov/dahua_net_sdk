...
/**
 * \if ENGLISH_LANG
 * @brief Intelli Module High Temp Event(corresponding to SDK_ALARM_INTELLI_MODULE_HIGH_TEMP)
 * \else
 * @brief 智能模块温度异常事件(对应 SDK_ALARM_INTELLI_MODULE_HIGH_TEMP)
 * \endif
 */
public class NET_ALARM_INTELLI_MODULE_HIGH_TEMP_INFO implements Serializable {
    /**
     *
     */
