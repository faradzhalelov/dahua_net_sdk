...
public class AV_CFG_VideoWidgetCustomTitle implements Serializable {
	...
	/**
	 * \if ENGLISH_LANG
	 * Title type "Rtinfo" real-time recorder information, "Custom" overlay, temperature and humidity overlay, "Title": credit information "Check" check code
	 * \else
	...
	/**
	 * \if ENGLISH_LANG
	 * Title alignment method,{@link EM_TITLE_TEXT_ALIGN}
	 * \else
	 * 标题对齐方式,{@link EM_TITLE_TEXT_ALIGN}
	 * \endif
	 */
	...
	/**
	 * \if ENGLISH_LANG
	 * update the overlay content on the device side or not
	 * \else
	 * 是否需要设备端更新叠加内容
	 * \endif
	 */
