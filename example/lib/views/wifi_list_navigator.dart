...
/// Navigator widget that handles login for WiFi list
class WifiListNavigator extends StatefulWidget {
  final CameraConfig config;

  const WifiListNavigator({super.key, required this.config});

  @override
  State<WifiListNavigator> createState() => _WifiListNavigatorState();
}

class _WifiListNavigatorState extends State<WifiListNavigator> {
  int? _loginHandle;
  ...
  Widget build(BuildContext context) {
    ...
    return WifiListView(loginHandle: _loginHandle!);
  }
}
