...
/**
 * Get disk type(Only for Windows32)
 *
 * @param[in] nDiskIndex disk index.
 * @return int,successful return disk type, 0 is DHFS, 1 is XFS; failed return negative number.
 */
...
typedef enum _IVS_TYPE
{
	...
	IVSINFOTYPE_DATA_WITH__VIDEO_INFO_OVERLAY = 25,//video Info overlay（0x23）
}IVS_TYPE;
